...
Bu yerda:
* — $QK^T$ → tokenlar o‘xshashligi
* — $\sqrt{d_k}$ → sonlar juda kattalashib ketmasligi uchun
...
Foizlar:
* — “Men” → $2.7 / 10.1 \approx 27\%$
* — “choy” → $7.4 / 10.1 \approx 73\%$
...
Transformerning eng katta ustunligi: u matnni oddiy text emas, vectorlar orasidagi matematik bog‘liqlik sifatida ko‘radi.
